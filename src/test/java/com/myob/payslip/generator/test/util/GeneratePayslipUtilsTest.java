package com.myob.payslip.generator.test.util;
...
public class GeneratePayslipUtilsTest {
	...
	public void calculateNetIncomeTest() {
		assertEquals(4082, GeneratePayslipUtils.calculateNetIncome(GeneratePayslipUtils.calculateGrossIncome(payslip2.getAnnualSalary()), 
																   GeneratePayslipUtils.calculateIncomeTax(payslip2.getAnnualSalary())),0.0);
	}
	
	@Test
	public void calculateSuperTest() {
		assertEquals(450, GeneratePayslipUtils.calculateSuper(GeneratePayslipUtils.calculateGrossIncome(payslip2.getAnnualSalary()), 
																   payslip2.getSuperRate()),0.0);
	}
}
